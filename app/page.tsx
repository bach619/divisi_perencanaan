      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-green-500 via-green-600 to-green-700 items-center justify-center p-12">
        <div className="max-w-lg text-white">
          ...
          <p className="text-lg text-green-50 leading-relaxed mb-8">
            Manage your finances with ease. Send, receive, and track payments globally with our secure platform.
          </p>
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-green-50">Fast and secure transactions worldwide</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 bg-white/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
              ...
              <p className="text-green-50">Multi-currency support for global business</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 bg-white/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
              ...
              <p className="text-green-50">24/7 customer support always ready to help</p>
            </div>
          </div>
        </div>
      </div>
